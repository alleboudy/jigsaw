...
var JigsawPuzzle = function (_a) {
    ...
    return react_1.default.createElement("div", {
        ...
        return react_1.default.createElement("div", {
            draggable: false, onMouseDown: function (event) { return onTileMouseDown(tile, event); }, onTouchStart: function (event) { return onTileMouseDown(tile, event); }, key: tile.correctPosition, className: "jigsaw-puzzle__piece ".concat(tile.solved ? ' jigsaw-puzzle__piece--solved' : '', " "), style: {
                position: 'absolute',
